...
columns_to_remove = []  # 0-based indexing for columns 5, 16, 17
...
df_clean.to_csv('removed_cleaned_cleveland.data', index=False, header=False)
print("\nCleaned dataset saved as '.data'")
